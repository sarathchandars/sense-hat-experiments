# Humidity logged in a .log file
# Realtime display of humidity on LED matrix
# Place hum_log.sh in crontab to run at startup
# Change path to humidity.py in .sh file as required
